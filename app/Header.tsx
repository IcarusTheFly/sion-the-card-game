...
// TO-DO: IMPLEMENT LOG IN !
  ...
  const links: LinkType[] = [{
    ...
    {name:"Cartas",href:"/cards"},{name: "Mazos",
        href: "/decks"
    },{name:"Reglamento",href:"/rules"}];

return (<header className="flex flex-col items-center justify-between bg-gray-950 px-4 py-4 text-white md:flex-row md:px-6 md:py-4">
